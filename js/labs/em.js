/**
 * HSN-Labs EM Lab — solenoid, core, and magnetic materials on the bench.
 */
...
<div class="lab-frame" id="app">
  ...
  <div id="viewport">
    ...
    <div class="legend">
      ...
      <div><i style="background:#9aa7b8"></i>Non-magnetic metal (Al)</div>
  ...
  <div class="inspector wide-only">
    ...
    <div class="section">
      <h2>Theory (soft-iron electromagnet)</h2>
